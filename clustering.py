...
most_common_words = ['as', 'I', 'his', 'that', 'he', 'was', 'for', 'on', 'are', 'with', 'they',
                     ...
                     'why', 'ask', 'men', 'change', 'went', 'light', 'kind', 'off', 'need', 'house', 'picture', 'try', 'us', 'again', 'animal', 'point', 'mother', 'world', 'near', 'build', 'self', 'earth', 'father', 'any', 'new', 'work', 'part', 'take', 'get', 'place', 'made', 'live', 'where', 'after', 'back',
...
v = list(
    filter(lambda x: x[0] not in most_common_words and x[1] > 5, tc.items()))
